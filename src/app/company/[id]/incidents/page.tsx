  ...
  return (
    <div className="flex h-screen" style={{ background: 'var(--bg-primary)' }}>
      ...
      <main className="flex-1 overflow-y-auto">
                    ...
                    <table className="w-full text-[12px]">
                      ...
                      <tbody>
                        {filteredDashIncidents.slice(0, 20).map((inc) => {
                          ...
                          return (
                            <tr key={inc.id} onClick={() => openDrawer(inc)} style={{ borderBottom: '1px solid var(--border)', cursor: 'pointer' }} className="hover:bg-[var(--bg-secondary)] transition-colors">
                              ...
                              <table className="w-full text-[12px]">
                                ...
                                <tbody>
                                  {propFilteredIncidents.slice(0, 30).map((inc) => {
                                    ...
                                    return (
                                    <tr key={inc.id} onClick={() => openDrawer(inc)} style={{ borderBottom: '1px solid var(--border)', background: hasWarning ? '#fffbeb05' : undefined, cursor: 'pointer' }} className="hover:bg-[var(--bg-secondary)] transition-colors">
        ...
        {/* ===================== INCIDENT DRAWER ===================== */}
        {drawerOpen && drawerIncident && (() => {
          // Find the source list for prev/next navigation
          const sourceList: Incident[] = (() => {
            if (viewMode === 'dashboard') {
