...
export default function EmployeesPage() {
  ...
  if (!isLoggedIn) {
    return (
      <div style={{ minHeight: "100%", background: "var(--bg)" }} style={{ background: 'var(--bg)' }}>        <main className=" p-8 flex items-center justify-center">
  ...
  /* ───── MAIN RENDER ───── */
  return (
    <div style={{ minHeight: "100%", background: "var(--bg)" }} style={{ background: 'var(--bg)' }}>      <main className=" overflow-auto">
            ...
            <div className="rounded-2xl p-6 w-full max-w-md" style={{ background: '#ffffff', boxShadow: '0 25px 60px rgba(0,0,0,0.3)' }} onClick={e => e.stopPropagation()}>
              ...
              <div className="flex gap-3 mt-5">
                <button onClick={() => { setShowModal(false); setEditingEmp(null); }}
                  className=" px-4 py-2.5 rounded-lg text-sm" style={{ background: '#e5e7eb', color: '#4b5563' }}>ยกเลิก</button>
