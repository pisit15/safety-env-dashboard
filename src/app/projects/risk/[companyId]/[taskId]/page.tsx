...
export default function RAFormPage() {
  ...
  if (!isLoggedIn) {
    return (
      <div style={{ minHeight: "100%", background: "var(--bg)" }}>        <main className=" p-6 lg:p-8 overflow-y-auto" style={{ background: 'var(--bg-primary)' }}>
  ...
  if (loading) {
    return (
      <div style={{ minHeight: "100%", background: "var(--bg)" }}>        <main className=" p-8 flex items-center justify-center" style={{ background: 'var(--bg-primary)', color: 'var(--muted)' }}>
          กำลังโหลด...
        </main>
      </div>
    );
  ...
  if (!task) {
    return (
      <div style={{ minHeight: "100%", background: "var(--bg)" }}>        <main className=" p-8 text-center" style={{ background: 'var(--bg-primary)' }}>
  ...
  return (
    <div style={{ minHeight: "100%", background: "var(--bg)" }}>      <main className=" p-4 lg:p-8 overflow-y-auto" style={{ background: 'var(--bg-primary)' }}>
