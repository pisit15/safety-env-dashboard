...
export default function NearMissCoordinatorPage() {
  ...
  if (!isLoggedIn) {
    return (
      <div style={{ minHeight: "100%", background: "var(--bg)" }}>        <main style={{ flex: 1, background: 'var(--bg-primary)', padding: '32px 24px' }}>
  ...
  // ── Main ───────────────────────────────────────────────────────────────
  return (
    <div style={{ minHeight: "100%", background: "var(--bg)" }} style={{ background: 'var(--bg-primary)' }}>      <main className=" overflow-y-auto" id="pdf-content">
