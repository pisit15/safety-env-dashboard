...
export default function AdminNearMissPage() {
  ...
  if (!auth.isAdmin) {
    return (
      <div style={{ minHeight: "100%", background: "var(--bg)" }}>        <main className=" flex items-center justify-center p-8">
  ...
  return (
    <div style={{ minHeight: "100%", background: "var(--bg)" }}>      <main className=" overflow-y-auto" style={{ background: 'var(--bg-primary)' }}>
