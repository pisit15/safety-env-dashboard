...
export default function ManHoursPage() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="flex h-screen" style={{ background: 'var(--bg-primary)' }}>        <main className=" flex items-center justify-center">
          <div
  ...
  return (
    <div className="flex h-screen" style={{ background: 'var(--bg-primary)' }}>      <main className=" overflow-y-auto" id="pdf-content">
        {/* Header */}
