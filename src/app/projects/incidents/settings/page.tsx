  ...
  return (
    <div style={{ padding: '28px 24px', maxWidth: 1000, margin: '0 auto' }}>
      ...
      <p style={{ fontSize: 12, color: 'var(--text-secondary)', margin: '0 0 18px' }}>
        รายการเหล่านี้ใช้ในฟอร์มบันทึกอุบัติการณ์ (เหตุการณ์, แหล่งที่มา, แหล่งที่มาต้นทาง, ลักษณะความเสียหาย) —
        แก้ไขแล้วมีผลทันทีกับทุกบริษัท • ปิดใช้งาน = ซ่อนจากรายการให้เลือก โดยข้อมูลเก่าไม่ได้รับผลกระทบ
      </p>

      <RefSection
        title="เหตุการณ์ (Event)"
      ...
      <RefSection
        title="แหล่งที่มา (Source)"
        hint="แกนที่ 2: สิ่งที่ทำให้เกิดเหตุ — ใช้รายการเดียวกันทั้งช่อง แหล่งที่มา และ แหล่งที่มาต้นทาง เพื่อชี้จุดโฟกัสมาตรการป้องกัน"
        rows={sources}
