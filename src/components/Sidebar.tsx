      ...
      <div className={`${collapsed ? 'hidden' : ''}`} style={{ borderTop: '1px solid var(--border)' }}>
        ...
        <div className="px-4 pb-4 pt-1">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[12px] font-semibold leading-tight" style={{ color: 'var(--text-primary)' }}>HSE HQ Admin</p>
              <p className="text-[10px] font-medium" style={{ color: 'var(--muted)' }}>กลุ่มบริษัท EA</p>
            </div>
          </div>
        </div>
      </div>
